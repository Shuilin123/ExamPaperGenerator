...
\hline
满分值 & 3.0分 & 3.0分 & 2.5分 & 15.0分 & 100分 & \multirow{2}{*}{} \\
\hline
实得分 & & & & & & \\
\hline
阅卷人 & & & & & & \\
...
\vspace{12pt}
\noindent\textbf{1、单项选择题}\par\vspace{4pt}
\begin{enumerate}
    \item 示例题目内容
\end{enumerate}
\vspace{8pt}
\noindent\textbf{2、多项选择题}\par\vspace{4pt}
\begin{enumerate}
    \item 示例题目内容
\end{enumerate}
\vspace{8pt}
\noindent\textbf{3、判断题}\par\vspace{4pt}
\begin{enumerate}
    \item 示例题目内容
\end{enumerate}
\vspace{8pt}
\noindent\textbf{4、简答题}\par\vspace{4pt}
\begin{enumerate}
    \item 示例题目内容
\end{enumerate}
\vspace{8pt}
